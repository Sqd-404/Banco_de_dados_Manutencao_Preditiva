...
CREATE TABLE `falha` (
  ...
  `failure_comp` tinyint unsigned NOT NULL,
  PRIMARY KEY (`date_time`,`machineID`,`failure_comp`),
  KEY `machineID` (`machineID`),
  KEY `failure_comp` (`failure_comp`),
  CONSTRAINT `falha_ibfk_1` FOREIGN KEY (`machineID`) REFERENCES `maquina` (`machineID`),
  CONSTRAINT `falha_ibfk_2` FOREIGN KEY (`failure_comp`) REFERENCES `comp` (`compID`)
...
INSERT INTO `falha` VALUES ('2023-01-13 08:30:00',1,1),('2023-11-08 15:30:00',3,1),('2023-11-25 16:15:00',2,1),('2023-02-15 09:15:00',2,2),('2023-07-10 13:15:00',3,2),('2023-03-22 10:00:00',3,3),('2023-04-30 11:45:00',2,4),('2023-09-11 14:00:00',7,4),('2023-05-15 12:30:00',5,5),('2023-10-06 14:45:00',8,5);
